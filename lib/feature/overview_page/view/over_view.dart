  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<OverViewController>(
        builder: (context, overViewProvider, _) => Padding(
          padding:
            ...
            child: Column(
              ...
              children: [
                ...
                UserDetailShowingWidget(
                  title: 'Pin Code',
                  subTitle:
                      overViewProvider.overviewObject?.address?.postalCode ??
                          "",
                ),
                UserDetailShowingWidget(
                  title: 'State',
                ...
                UserDetailShowingWidget(
                  ...
                  subTitle: DateFormat('dd-MM-yyyy')
                      .format(overViewProvider.overviewObject!.birthDate!),
                ),
                UserDetailShowingWidget(
                  title: 'Height',
                  subTitle:
                ...
                UserDetailShowingWidget(
                  title: 'Eye Color',
                  subTitle: "${overViewProvider.overviewObject?.eyeColor}",
                ),
                UserDetailShowingWidget(
                  title: 'Gender',
                ...
                UserDetailShowingWidget(
                  title: 'Hair Color',
                  subTitle: "${overViewProvider.overviewObject?.hair?.color}",
                ),
                UserDetailShowingWidget(
                  title: 'Hair Type',
                  subTitle: "${overViewProvider.overviewObject?.hair?.type}",
                ),
                UserDetailShowingWidget(
                  title: 'Phone',
                ...
                UserDetailShowingWidget(
                  maxLines: null,
                  title: 'University',
                  subTitle: "${overViewProvider.overviewObject?.university}",
                ),
                UserDetailShowingWidget(
                  maxLines: 1,
                  title: 'Weight',
                ...
                UserDetailShowingWidget(
                  maxLines: 1,
                  title: 'Iban',
                  subTitle: "${overViewProvider.overviewObject?.bank?.iban}",
                ),
                const CustomHeight10(),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: TextStyle(
          ...
          fontSize: Responsive.textMultiplier! * 1.8),
    );
  }
}
